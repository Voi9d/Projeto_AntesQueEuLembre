label escola:
    ...
    if trematraso == True:
        ...
        scene narrador
        with dissolve
        "{cps=40}Kioku começa a estudar, revisa cada conteúdo que irá cair na sua prova, cada centímetro, porque ele sabe, mesmo que precise de pouca nota, que a prova final de seu professor, é sempre a mais difícil.{/cps}"
        ...
        "Confrontar Subaru":
            ...
            menu:
                ...
                "{b}{i}SoCaR SuBuRu{/i}{/b}":
                    ...
                    "{cps=40}Tudo ficou escuro na visão de Kioku, unica coisa que ele conseguia ouvir era seus punhos batendo contra o rosto de Subaru....{/cps}"
                    "{cps=40}De novo....{/cps}"
                    "{cps=40}De novo....{/cps}"
                    "{cps=40}De novo....{/cps}"
                    ...
                    "???" "{cps=40}{i}É bom né Kioku, esse sentimento.... de prazer ao ver alguém {size=+10}DESPREZÍVEL{/size} como ele no chão...{/i}{/cps}"
                    ...
                    "???" "{cps=40}{i}Porque você ta parado Kioku? Vamos, eu sei que você queria ele bem pior do que já está, e eu sei.... Que você consegue fazer ele ficar pior.{/i}{/cps}"
                    ...
                    menu:
                        "{b}{i}FiNaLiZaR O SuBuRu{/i}{/b}":
                            ...
                            play audio "audio/SoundsEffects/headbreak.mp3"
                            $ unlock_achievement('darkpassager')
                        ...
                        "{b}{i}FiNaLiZaR SuBuRu{/i}{/b}":
                            ...
                            "7"
                            "{cps=40}....{/cps}"
                            "{cps=40}Kioku já perdeu as contas, apenas continuava, até ele não poder mais....{/cps}"
                            ...
                            "???" "{cps=40}{i}Isso Kioku, é isso que ele merece, alguém fraco como ele, não merece seu perdão, você mostrou a ele o {size=+10}SEU{/size} lugar{/i}{/cps}"
                            $ unlock_achievement('darkpassager')
...
label oquerealmenteaconteceu:
    ...
    call rolar_d20_base(dc=10, atributo='labia', titulo="Teste de Intimidação: Subaru", reveal_result = True)
    $ resultado = _return
    if resultado:
...
label provafinal:
    ...
    if provaatraso == True:
        ...
        k feliz "{cps=40}{i}A Jinsei já terminou a prova.{/i}{/cps}"
        ...
        menu:
            "Contar sobre Subaru":
                ...
                if trematraso == True:
                    k normal "{cps=40}\"O Ichida quase me fez chegar atrasado na prova.\"{/cps}"
                ...
                k normal "{cps=40}\"Tenho sim, já resolvi a situação, ele não vai mais me incomodar\"{/cps}"
                hide JinseiTriste
                show JinseiSurpresa
                ...
                menu:
                    "Contar a Verdade":
                        ...
                        hide JinseiSurpresa
                        show JinseiNormal
                        j NNormal "{cps=40}\"Meu deus... E como foi?\"{/cps}"
                        "{cps=40}Jinsei responde com um tom de normalidade, como se não estivesse surpresa com o que o Kioku fez.{/cps}"
                        j NNormal "{cps=40}\"Sentiu algo? Foi bom?\"{/cps}"
                        k normal "{cps=40}\"Não sei, eu não senti nada, mas ele sangrou bastante...\"{/cps}"
                        k divertindo "{cps=40}\"Mas acho que eu não acharia bom ou me sentir bem em bater em alguém hahaha\"{/cps}"
                        hide JinseiNormal
                        show JinseiFeliz4
                        ...
                        menu:
                            "Contar o que realmente aconteceu":
                                ...
                                hide JinseiFeliz
                                show JinseiSurpresa
                                j Surpresa "{cps=40}\"O-oi? O que? Você teve o que?\"{/cps}"
                                k normal "{cps=40}\"Eu sei que parece loucura, mas eu tive essas visões, e elas eram tão reais...\"{/cps}"
                                j Surpresa "{cps=40}\"I-isso é muito estranho Kioku... V-você tem certeza que não s-se preciptou?\"{/cps}"
                                ...
                                j Surpresa "{cps=40}\"B-bom... Se você tiver mais dessas visões, me conte tá? E se sentir algo estranho, me avisa também...\"{/cps}"
                            ...
                            "Não contar o que realmente aconteceu":
                                    ...
                                    jump kiokuse
                    "Esconder a Verdade":
                        call rolar_d20_base(dc=5, atributo='labia', titulo="Teste de Lábia: Esconder a Verdade", reveal_result = True)
                        $ resultado = _return
                        if resultado:
            ...
            "Não contar a verdade":
                call rolar_d20_base(dc=8, atributo='labia', titulo="Teste de Lábia: Esconder a Verdade", reveal_result = True)
                $ resultado = _return
                if resultado:
        ...
        if trematraso == True:
            ...
            k feliz "{i}{cps=40}Jinsei já tá ai, que bom que ela guardou um lugar pra mim{/i}{/cps}"
            ...
            k feliz "{cps=40}\"O senhor sendo o melhor professor que já tivemos, e que sempre{nw}{/cps}\""
            ...
            "{cps=40}Mais alguns murmúrios continuam na sala, até que Yuki termina de entregar a prova{/cps}"
            ...
            "{cps=40}Se passa 1 hora, e Kioku está finalizando sua prova, Jinsei já havia terminado e saído da sala, faltava apenas Kioku e alguns poucos alunos{/cps}"
            "{cps=40}Mais alguns minutos, Kioku termina a prova, se levanta e entrega para Yuki, que recebe a prova e lhe deseja boa sorte.{/cps}"
            ...
            hide Jinseibravanime
            show Jinseibravanime at left_pos
            show Yuki normal at right_pos with moveinright
            y normal "{cps=40}\"Desculpa atrapalhar a conversa importantissima de vocês, mas tenho uma prova para aplicar, por favor, se ajeitem.\"{/cps}"
            $ desbloquear_Personagem("yuki")
            hide Jinseibravanime
...
label kiokuse:
    ...
    "???" "{cps=40}{i}\"Ora... já esqueceu de mim? Bem, não posso culpar você, faz tanto tempo depois daquele dia...\"{/i}{/cps}"
    ...
    play audio "audio/SoundsEffects/sinal2.mp3"
    pause 2.0
    $ renpy.music.set_volume(1.0, delay=1.0, channel='music')
...
label encontrostella:
    ...
    scene escadaescoladia
    with pixellate
    if  consequência_ativada["conhecer_estella"] == True:
        ...
        hide Stella feliz
        show Stella happy1
        s happy1 "{cps=40}\"Sim, eu acabei de concluir minha transferência pra cá, e me falaram que era para encontrar o \"Senhor Kioku\" que iria me apresentar a Faculdade...\"{/cps}"
        ...
        k normal "{cps=40}\"Mas não seria o presidente do grêmio estudantil?\"{/cps}"
        if subarusangue == True:
            hide Stella feliz
            show Stella envergonhada
            ...
            hide Stella feliz
            show Stella envergonhada
            "???" "{cps=40}\"Ah, é, mas ele não estava disponível porque parece que ele teve um imprevisto... Ai me falaram que era para me encontrar com você...\"{/cps}"
            hide Stella envergonhada
            show Stella feliz
            k normal "{cps=40}\"Ah sim....\"{/cps}"
            k triste "{cps=40}{i}Subaru tendo imprevisto? Isso não é normal....{/i}{/cps}"
        ...
        menu:
            "Perguntar sobre o nome":
                ...
                k feliz "{cps=40}\"Ah, entendi... Que legal, deve ser uma experiência interessante crescer aqui com uma cultura tão diferente da dos seus pais...\"{/cps}"
                hide Stella envergonhada
                show Stella feliz
                ...
                menu:
                    "Perguntar sobre a transferência":
                        ...
                        k feliz "{cps=40}\"Ah, entendi... Bom, espero que aqui seja um bom recomeço pra você então...\"{/cps}"
                        hide Stella happy1
                        show Stella feliz
        ...
        show Stella happy2
        with dissolve
        s happy2 "{cps=40}\"...Eai quando eu cheguei em casa, eu vejo ele embaixo da cama hahahahahaha...{/cps}\""
        s happy2 "{cps=40}\"Esse tempo todo, ele estava embaixo da minha cama, e eu dando voltas e voltas no meu bairro, hahahahah....{/cps}\""
        k divertindo "{cps=40}\"Hahahaha, você deve ter achado engraçado na hora né?\"{/cps}"
        s happy2 "{cps=40}\"Na hora eu briguei com ele porque ele não me respondia, nem quando eu chamava com a ração hahahaha.{/cps}\""
        hide Stella happy2
        show Stella feliz3
        s feliz3 "{cps=40}\"Mas depois eu achei engraçado, porque ele estava lá, e eu nem tinha percebido...\"{/cps}"
        hide Stella feliz3
        show Stella feliz
        s feliz "{cps=40}\"Aiai, nossa, nem vi o tempo passar, obrigada por me mostrar a Faculdade Kioku, eu adorei conhecer tudo isso...\"{/cps}"
        k feliz "{cps=40}\"Ah, que bom que você gostou Estella, eu também adorei te mostrar a Faculdade e conversar com você...\"{/cps}"
...
label celularestella:
    if consequência_ativada["celular_estella"] == True:
        ...
        hide Stella feliz
        show Stella envergonhada
        s envergonhada "{cps=40}\"Você tem algum número de telefone pra me passar? Sabe, pra gente conversar melhor sobre a faculdade e tudo mais.\"{/cps}"
        hide Stella envergonhada
        show Stella feliz2
        k feliz "{cps=40}\"Ah, claro, eu te passo meu número...\"{/cps}"
        s feliz2 "{cps=40}\"Ah, obrigada Kioku.\"{/cps}"
