...
define build.name = "Antes_que_eu_Lembre"
...
define config.save_directory = "ProjetoJogoEscolha-1766010330"

## Visibilidade das abas Auto/Quick no menu Carregar
define config.has_autosave = False
define config.has_quicksave = False

## Controle manual de salvamento - permite salvar apenas quando permitido
default persistent.can_save_game = False

## Desabilita a tecla TAB para pular diálogos
init python:
    config.keymap['skip'] = []
    config.keymap['toggle_skip'] = []
    # Mapear ESC para abrir o menu do jogo
